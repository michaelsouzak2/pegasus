...
#    st.session_state["products"] = get_bounding_boxes(
#        start_date=start_date.isoformat() + "T00:00:00.000Z",
#        end_date=end_date.isoformat() + "T23:59:59.000Z"
#    )
#    st.session_state["map"] = generate_map(st.session_state["products"])    
...
products = get_products_cached(start_date, end_date)
map = generate_map(products)
st_folium(map, use_container_width=True)
